...
async def list_property(current_user:ActiveAgent,payload:PropertyBase,db:DBSession):
...
async def edit_property_listing(property_id:int,update_data:PropertyUpdate,current_user:ActiveAgent,db:DBSession):
