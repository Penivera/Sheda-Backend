...
class Settings(BaseSettings):
    ...
    # Verification
    VERIFICATION_CODE_EXP_MIN: int = Field(default=15, description="Verification code expiration in minutes")
    ...
    METHODS: list[str] = Field(default=["GET", "POST", "PUT", "DELETE", "OPTIONS"], description="CORS allowed methods")
    ALLOW_HEADERS: list[str] = Field(default=["Content-Type", "Authorization", "X-Requested-With", "Accept", "Origin", "Access-Control-Allow-Origin", "Access-Control-Allow-Methods", "Access-Control-Allow-Headers"], description="CORS allowed headers")
